...
Vendored from https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/command.md
...
- Use semantic HTML (`<main>`, `<nav>`, `<header>`, `<footer>`) before ARIA
...
- Prefer `<video>` over animated GIF; provide a still alternative
- Short non-essential loops: Safari H.264 MP4 `<source>`, `prefers-reduced-motion` media condition, and still fallback
